...
public class ProductosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            out.println(".container {max-width: 900px; margin: 40px auto; background-color: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.2); text-align: center;}");
            out.println("h1 {color: #0a3d62; margin-bottom: 20px;}");
            out.println("table {margin: 0 auto; border-collapse: collapse; width: 90%; background-color: white;}");
            out.println("th, td {border: 1px solid #999; padding: 10px 15px; text-align: center;}");
            out.println("th {background-color: #0a3d62; color: white;}");
            out.println("tr:nth-child(even) {background-color: #f0f0f0;}");
            out.println("tr:hover {background-color: #dff0ff;}");
